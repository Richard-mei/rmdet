...
default_formats = {
    ...
    # 'log_format': '%(asctime)s-%(name)s-%(filename)s-[line:%(lineno)d]-%(levelname)s-[log]: %(message)s'
}
color_formatter = colorlog.ColoredFormatter(default_formats["color_format"], log_colors=log_colors_config)
log_formatter = logging.Formatter(default_formats["log_format"])
